      ...
      <div className="container mx-auto px-6 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col">
            ...
            <h6 className="text-text-primary mb-4 text-lg font-semibold">Contact Information</h6>
          ...
          {/* Helpful Links */}
          <div className="flex flex-col">
            <h6 className="text-text-primary mb-4 text-lg font-semibold">Helpful Links</h6>
          ...
          {/* Newsletter & Social */}
          <div className="flex flex-col">
            <h5 className="text-text-primary mb-4 text-xl font-bold">Get In Touch!</h5>
            
            <div className="flex mb-6">
              <input
                type="email"
                placeholder="Enter Your Email"
                className="flex-1 px-4 py-2 bg-bg-primary text-text-primary border border-white/10 focus:outline-none focus:border-border-accent transition-colors"
              />
              <Custbutton btn="Subscribe" styleType="smCta" />
            </div>

            <h6 className="text-text-primary mb-3 text-lg font-semibold">Follow Us</h6>
            <div className="flex items-center gap-4">
              {/* Facebook */}
              <Links path="https://www.facebook.com" styleType="link">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={28}
                  height={28}
              ...
              {/* YouTube */}
              <Links path="https://www.youtube.com" styleType="link">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={32}
                  height={32}
              ...
              {/* LinkedIn */}
              <Links path="https://www.linkedin.com" styleType="link">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={32}
                  height={32}
              ...
              {/* Instagram */}
              <Links path="https://www.instagram.com" styleType="link">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={34}
                  height={34}
