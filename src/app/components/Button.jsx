const styles = {
  ...
  bgCta:
    "bg-bg-accent px-6 md:px-10 py-3 md:py-4 text-text-primary font-heading shadow-md cursor-pointer text-base md:text-xl transition-all duration-300 ease-in-out hover:bg-orange-700 flex items-center justify-center gap-2 hover:gap-4 whitespace-nowrap w-full sm:w-[200px]",
