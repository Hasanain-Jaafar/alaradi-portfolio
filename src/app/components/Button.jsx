...
const styles = {
  ...
  bgCta:"bg-bg-accent px-[2.5rem] py-[1.25rem] text-text-primary font-heading shadow-md cursor-pointer text-xl transition-all duration-300 ease-in-out hover:bg-orange-700 shadow-[#ffffff5c]/20 flex items-center gap-2 hover:gap-4",
  navBtn:
  ...
  chostBtn:" border border-border-accent px-[5rem] py-[1.25rem] text-text-accent font-heading tracking-widest text-xl  shadow-md cursor-pointer transition-all duration-300 ease-in-out shadow-[#ffffff5c]/20 flex items-center hover:text-text-secondary hover:bg-bg-secondary",
};
