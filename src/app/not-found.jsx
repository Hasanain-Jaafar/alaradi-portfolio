    ...
    <div className="min-h-screen bg-primary text-primary flex items-center justify-center px-6">
      <div className="text-center max-w-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/"
            className="inline-flex items-center justify-center gap-2 text-text-primary bg-text-accent-light hover:bg-[#fb923c]  px-8 py-3 rounded-lg font-semibold transition-all"
          >
            <Home size={20} />
            Back to Home
          </Link>
