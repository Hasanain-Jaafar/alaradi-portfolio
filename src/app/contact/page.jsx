          ...
          <div className="grid md:grid-cols-5 gap-12">
            ...
            <div className="md:col-span-3">
              <div className="bg-bg-secondary border border-subtle rounded-lg p-8">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 text-text-secondary placeholder:text-text-secondary">
                  {/* Name Field */}
                  <div>
                  ...
                  {submitStatus === 'error' && (
                    <div className="bg-red-500/10 border border-red-500 rounded-lg p-4 flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-red-500 mb-1">Something Went Wrong</h4>
                        <p className="text-sm text-secondary">
                          Please try again or email me directly at support@alaradi.com
                        </p>
                      </div>
                    </div>
                  )}
