...
export const metadata = {
  ...
  description: 'Professional web development services using modern frameworks and best practices.',
};
...
export default function WebDevelopmentPage() {
  ...
  const technologies = [
    ...
    'Node.js', 'PostgreSQL', 'MongoDB', 'API Development'
  ];
  ...
  const process = [
    ...
    },
    {
      ...
      description: 'Creating wireframes, design mockups, and technical architecture plans.',
    },
    {
      step: '03',
      title: 'Development',
      description: 'Building your application with clean code, best practices, and regular updates.',
    },
    {
      step: '04',
      title: 'Testing & Launch',
      description: 'Thorough testing, bug fixes, deployment, and post-launch support.',
    },
  ];
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-xl text-text-secondary leading-relaxed max-w-3xl">
            ...
            From concept to launch, I create digital experiences that your users will love.
          </p>
        </div>
      </section>
